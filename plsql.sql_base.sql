...
BEGIN
    ...
    VALUES 
    (NEW.id_prestamo, NEW.id_administrador, 'NUEVA_SANCION', CONCAT('Sanción ID: ', NEW.id_sancion, ' aplicada al usuario ', NEW.id_usuario, '. Motivo: ', NEW.motivo, '. Multa: $', IFNULL(NEW.monto_multa, 0)), CURRENT_USER());
END //
